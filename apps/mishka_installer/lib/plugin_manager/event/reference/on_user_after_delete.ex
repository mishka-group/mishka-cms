defmodule MishkaInstaller.Reference.OnUserAfterDelete do
  @moduledoc """
    This event is triggered whenever a user is successfully deleted. if there is any active module in this section on state,
  ...
  @type ref() :: :on_user_after_delete # Name of this event
  ...
  @type state() :: %__MODULE__{user_info: user_info(), ip: ip(), endpoint: endpoint(), modifier_user: user_id() | :self}
