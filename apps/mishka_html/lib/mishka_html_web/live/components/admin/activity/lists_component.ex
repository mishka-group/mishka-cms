        ...
        <div class="table-responsive">
            ...
            <div class="col-sm-10">
                <%= if @activities.entries != [] do %>
                    <.live_component module={MishkaHtmlWeb.Public.PaginationComponent} id={:pagination} pagination_url={@pagination_url} data={@activities} filters={@filters} count={@count} />
