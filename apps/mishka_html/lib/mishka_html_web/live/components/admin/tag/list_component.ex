    ...
    ~H"""
        <div class="col bw admin-blog-post-list">
            <div class="table-responsive">
                <table class="table vazir">
                    ...
                    <tbody>
                        ...
                        <tr class={"blog-list vazir #{if(color == "glist", do: "odd-list-of-blog-posts", else: "")}"}>
                            ...
                            <td class="align-middle text-center">
                                <.live_component module={MishkaHtmlWeb.Public.TimeConverterComponent} id={"updated-#{item.id}-component"} span_id={"updated-#{item.id}-component"} time={item.updated_at} />
                            </td>
                ...
                <div class="col-sm-10">
                    <%= if @tags.entries != [] do %>
                    <.live_component module={MishkaHtmlWeb.Public.PaginationComponent} id={:pagination} pagination_url={@pagination_url} data={@tags} filters={@filters} count={@count} />
                <% end %>
                </div>
            </div>
        </div>
