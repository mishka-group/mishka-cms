defmodule MishkaHtmlWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: MishkaHtmlWeb

      import Plug.Conn
      import MishkaHtmlWeb.Gettext
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/mishka_html_web/templates",
        namespace: MishkaHtmlWeb
  ...
  defp view_helpers do
    quote do
      ...
      import MishkaHtmlWeb.ErrorHelpers
      import MishkaHtmlWeb.Gettext
      alias MishkaHtmlWeb.Router.Helpers, as: Routes
    end
  end
